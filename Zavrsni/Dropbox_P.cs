...
namespace Zavrsni
{
    public partial class Dropbox_P : Form
    {
        ...
        private void Dropbox_P_Load(object sender, EventArgs e)
        {
        ...
        {
            UniValue file = (UniValue)listBox1.Items[0];
            if (file["path"] != "..")
            {
                MessageBox.Show("Chose the subject in which you want to add materials!");
                return;
            }
            OAuthUtility.PostAsync
                (
